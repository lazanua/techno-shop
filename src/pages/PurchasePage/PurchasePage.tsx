    ...
    <div className="container">
      {!isCompleted && (
        <div className="pt-[48px] pb-[24px] text-[12px] text leading-[1.33] text-[var(--gray-scale---60)]">
          <h4 className="subtitle">Оформлення замовлення</h4>
          <div className="flex gap-[16px]">
            <div className="flex-col gap-[24px] w-[1016px]">
              <div className="">
                ...
                >
                  {filteredProducts.map((product) => (
                    <div
                      className="flex justify-between items-center p-[12px]"
                      style={{
                        borderBottom: "1px solid var(--gray-scale---10)",
                      }}
                    >
                      <div className="flex gap-[30px] items-center w-[484px]">
                        <img
                          src={product.img}
                        ...
                        {product.discountedPrice && (
                          <div className="mt-[15px]">
                            ...
                            <div className="ml-[12px]">
                              ...
                              >
                                {product.discountedPrice}
                                <span style={{ fontSize: "8px" }}>грн.</span>
                              </p>
                            </div>
                          </div>
                        )}
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-400 text-[var(--dark-grey)] text-[14px] mt-[12px]">
                          ...
                          <span className="ml-[2px] text text-[8px]">грн.</span>
                        </p>
                      </div>
                      <button
                        className="link"
              ...
              <div className="mt-[24px]">
                <div className="subsubtitle mb-[19px]">Ваші контактні дані</div>
              ...
              <div className="mt-[16px]">
                ...
                >
                  <div className={`flex border rounded-[4px] justify-between`}>
                    <input
                      type="text"
              ...
              <div className="mt-[16px]">
                ...
                <button
                  className="button w-[500px] mt-[16px]"
            ...
            <div className="shadow flex flex-col p-[16px] text-p-grey w-[500px] max-h-[308px]">
